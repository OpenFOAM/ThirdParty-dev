...
functional scope of the \metis\ compatibility library, and coded
\textsc{CMake} environment files;
\item
...
\item
Connor Alexander Mayon coded the genetic algorithm partitioning
methods, available since version \textsc{7.0.10};
\item
